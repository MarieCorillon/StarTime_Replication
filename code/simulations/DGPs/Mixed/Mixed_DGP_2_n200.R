# Mixed Simulation Parameters (DGP2)
# --- Core Simulation Parameters ---
n <- 200            # Low-frequency sample size
...
X_ar <- rep(0.2, 10)          # AR(1) coefficients for each X

# --- MIDAS Weight Parameters (first 3 matter) ---
weight_params <- list(
  c(1,1,3),   # For X1
  c(1,2,3),   # For X2
  c(1,2,2)    # For X3
  # X4-X10 are noise, no weights needed
)
...
P_list = list(c(4,1),c(12,4,1), c(12,4,1),c(12,4,1), c(12,4,1), c(12,4,1),
              c(12,4,1), c(12,4,1), c(12,4,1),c(12,4,1), c(12,4,1))
Ki_list = list(c(4,1),c(3,4,1), c(3,4,1), c(3,4,1), c(3,4,1), c(3,4,1), c(3,4,1), 
               c(3,4,1), c(3,4,1), c(3,4,1), c(3,4,1))
